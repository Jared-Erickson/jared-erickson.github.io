...
!function(t) {
      ...
      , s = function(e) {
        ...
        return this.each(function() {
            ...
            if (this !== document && this !== window)
                return !document.scrollingElement || this !== document.documentElement && this !== document.body ? (e[n]() > 0 ? l.push(this) : (e[n](1),
                o = e[n]() > 0,
                o && l.push(this),
                e[n](0)),
                void 0) : (l.push(document.scrollingElement),
                !1)
        }),
            ...
            return this.unbind("click.smoothscroll").bind("click.smoothscroll", function(l) {
                ...
                if (i.scrollTarget || m && p && g) {
                    for (; h && f < c.length; )
                        r.is(e(c[f++])) && (h = !1);
                    for (; h && u < a.length; )
                        r.closest(a[u++]).length && (h = !1)
                } else
                    h = !1;
                h && (i.preventDefault && l.preventDefault(),
                t.extend(d, i, {
    ...
    t.smoothScroll = function(e, l) {
        ...
        /^(?:HTML|BODY)$/.test(s[0].nodeName) || (a = s[u]())) : s = t("html, body").firstScrollable(n.direction),
        n.beforeScroll.call(s, n),
        r = "number" == typeof e ? e : l || t(n.scrollTarget)[f]() && t(n.scrollTarget)[f]()[n.direction] || 0,
        h[u] = r + a + n.offset,
        i = n.speed,
        "auto" === i && (c = h[u] - s.scrollTop(),
        0 > c && (c *= -1),
...
!function(a) {
    a.fn.animatedModal = function(n) {
        ...
        d.click(function(n) {
            ...
            e.beforeClose(),
            m.hasClass(e.modalTarget + "-on") && (m.removeClass(e.modalTarget + "-on"),
            m.addClass(e.modalTarget + "-off")),
            m.hasClass(e.modalTarget + "-off") && (m.removeClass(e.animatedIn),
